...
// 데이터 베이스 호스트 이름
#define FIREBASE_HOST  "led-control-70c32-default-rtdb.firebaseio.com"
// 데이터 베이스 비밀번호
#define FIREBASE_AUTH "sxjwMEPvyUZ7S43VdqAhQ7R4p8cXJxxtafqXQc54"

// Wi-Fi 설정
#define WIFI_SSID "U+NetCBE3"
#define WIFI_PASSWORD "4000012552"
